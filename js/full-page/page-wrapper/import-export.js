        ...
        methods: 
        {
            ...
            SendData()
            {
                ...
                if(result==true)
                {
                    alert("data imported"); 
                    this.excel_data = []; 
                    this.$emit("import-excel-success"); 
                } 
                else 
                {
                    console.log(result); 
            ...
            <fragment>
                <vs-row>
                    <vs-col vs-w="6" vs-align="center" vs-justify="center" vs-type="flex">
                        <vs-button color="primary" type="border" icon="table_view" :href="'server/controller/excel/create_file.php?building_id=' + $route.params.building_id + '&controller=' + CurrentController">Download Excel Template</vs-button>
                    </vs-col>
