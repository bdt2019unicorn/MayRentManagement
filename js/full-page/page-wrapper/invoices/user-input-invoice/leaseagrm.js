...
(
    "invoice-leaseagrm", 
    {
        ...
        computed: 
        {
            ValidInvoiceDetails: ()=>this.ValidInvoiceDetailsLeaseagrm(this.invoice_details)
        },
        methods: 
        {
            NewValueChangeValid: (edit_data, name, new_value, reactive=false)=> new Promise
            (
                (resolve, reject)=>
                {
            ...
            PopulateList: (value)=> new Promise
            (
                (resolve, reject)=>
                {
